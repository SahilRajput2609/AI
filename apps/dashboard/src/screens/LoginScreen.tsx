...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Zap, Shield, Users, Check, Globe, Sun, ChevronDown } from 'lucide-react'
          ...
          <div className="bg-[#111111] border border-[#202020] rounded-[22px] p-10 sm:p-12 shadow-[0_0_80px_rgba(0,0,0,0.5)]">
            ...
            >
              ...
              <p className="text-sm text-[#6B7280]">
                {isSignUp ? 'Enter your details to get started.' : 'Sign in to continue to your workspace.'}
              </p>
            </motion.div>
              ...
              {!isSignUp && (
                ...
                >
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    ...
                    <span className="text-xs text-[#6B7280] group-hover:text-[#A1A1AA] transition-colors">
                      Remember me
                    </span>
                  </label>
                  <button
