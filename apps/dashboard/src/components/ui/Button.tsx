...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', icon, isLoading, children, disabled, ...props }, ref) => {
    ...
    const variantStyles = {
      primary: 'bg-white text-black hover:bg-white/95 active:scale-[0.98] shadow-sm hover:shadow-md',
      secondary: 'bg-[#111] text-white border border-[#333] hover:bg-[#1a1a1a] active:scale-[0.98]',
      ghost: 'text-[#A1A1AA] hover:text-white hover:bg-white/5 active:scale-[0.98]',
