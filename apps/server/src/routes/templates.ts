  ...
  const templates = [
    {
      ...
      description: 'A modern React SPA with TypeScript',
      category: 'frontend',
      type: 'project',
      config: JSON.stringify({ framework: 'react', starter: 'vite' }),
      is_built_in: true,
    },
    {
      ...
      category: 'frontend',
      type: 'project',
      config: JSON.stringify({ framework: 'nextjs', starter: 'create-next-app' }),
      is_built_in: true,
    },
    {
      name: 'Node.js API',
      ...
      category: 'backend',
      type: 'project',
      config: JSON.stringify({ framework: 'express' }),
      is_built_in: true,
    },
    {
      name: 'Python FastAPI',
      ...
      category: 'backend',
      type: 'project',
      config: JSON.stringify({ framework: 'fastapi' }),
      is_built_in: true,
    },
    {
      name: 'Landing Page',
      ...
      category: 'website',
      type: 'project',
      config: JSON.stringify({ framework: 'html' }),
      is_built_in: true,
    },
    {
      name: 'Portfolio Site',
      ...
      category: 'website',
      type: 'project',
      config: JSON.stringify({ framework: 'react' }),
      is_built_in: true,
    },
    {
    ...
    },
    {
      ...
      category: 'fullstack',
      type: 'project',
      config: JSON.stringify({ framework: 'nextjs' }),
      is_built_in: true,
    },
    {
      ...
      category: 'extension',
      type: 'project',
      config: JSON.stringify({ framework: 'vanilla' }),
      is_built_in: true,
    },
    {
      name: 'AI Agent',
      description: 'Custom AI agent with tools',
      category: 'ai',
      type: 'project',
      config: JSON.stringify({ framework: 'langchain' }),
      is_built_in: true,
    },
  ]
