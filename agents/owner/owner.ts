...
import { OwnerTask, TaskPriority, ReviewDecision } from './owner.types';
...
export class Owner {
  ...
  createAndSubmitTask(title: string, description: string, priority: TaskPriority = 'medium', category: string = 'general'): OwnerTask {
