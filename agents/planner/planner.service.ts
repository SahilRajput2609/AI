import { SubTask, Plan, PlannerState } from './planner.types';
...
export class PlannerService {
  ...
  addSubTask(planId: string, description: string, estimatedEffort: SubTask['estimatedEffort'], assignedRole: string, dependencies: string[] = []): SubTask | null {
